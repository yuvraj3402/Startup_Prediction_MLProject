...
from project.entity.config_entity import DataIngestionConfig,TrainingPipelineConfig,DataValidationConfig,DataTransformationConfig,\
ModelTrainerConfig,ModelEvaluationConfig,ModelPusherConfig
from project.constant import *
from project.util import read_yaml_file
import os,sys
...
class configuration:
    ...
    def get_data_ingestion_config(self)->DataIngestionConfig:
        try:
            ...
            dataset_url=data_ingestion_info[DATASET_URL_KEY]
